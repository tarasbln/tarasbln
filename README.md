...
:bar_chart: I specialize in data analytics within the financial sector, leveraging AI-powered solutions to drive strategic decision-making and optimize operational efficiency.

:hammer_and_wrench: Proficient in Python, SQL, Excel, and Tableau, I have a proven track record in transforming complex datasets into clear, actionable insights through advanced data visualization, predictive modeling, and process automation. My focus lies in delivering scalable solutions that empower informed business decisions and measurable outcomes.
